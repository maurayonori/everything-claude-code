...
```bash
gh api repos/maurayonori/everything-claude-code \
...
```bash
gh api repos/maurayonori/everything-claude-code/traffic/views
gh api repos/maurayonori/everything-claude-code/traffic/clones
```
