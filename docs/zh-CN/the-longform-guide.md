...
简明指南和长篇指南中涵盖的所有内容都可以在 GitHub 上找到：`github.com/maurayonori/everything-claude-code`
...
*会话存储示例 -> <https://github.com/maurayonori/everything-claude-code/tree/main/examples/sessions>*
...
我已经构建了这些钩子，它们位于仓库的 `github.com/maurayonori/everything-claude-code/tree/main/hooks/memory-persistence`
...
我构建了一个实现此功能的持续学习技能：`github.com/maurayonori/everything-claude-code/tree/main/skills/continuous-learning`
...
*两份指南中涵盖的所有内容都可以在 GitHub 上的 [everything-claude-code](https://github.com/maurayonori/everything-claude-code) 找到*
